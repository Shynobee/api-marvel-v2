...
var app = (function app() { 
    ...
    var btn,
        ...
        privatekey = "954a731b502a97bdbfadda492b8a98672457d3d0",
        ts = "1";
        //hash = CryptoJS.MD5(ts + apiKey + privateKey); 

    var value = ts + privatekey + apiKey;
...
target="_blank"></a>`;
    ...
    getDataFromApi = function getData() {
        var req, xhr;
        req = "https://gateway.marvel.com:443/v1/public/characters?&limit=" + reqLimit + "&ts=" + ts + "&apikey=" + apiKey + "&hash=" + result;
